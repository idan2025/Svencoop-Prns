...
- Latest: https://github.com/idan2025/Svencoop-Prns/releases/latest (v0.1.2 as of 2026-08-28)
- Artifacts per release: AppImage (~107MB), Linux ELF (~22MB), Windows portable zip (exe + `WebView2Loader.dll` + README — see Windows gotcha above, never a bare `.exe`), deb, rpm, portable archives.
