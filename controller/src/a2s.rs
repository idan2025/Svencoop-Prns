//! Minimal client for Valve's server query protocol (A2S), used to pull live
//! stats — player count, map, connected players — straight from the running
//! GoldSrc dedicated server over UDP. No RCON, no game-side integration
//! needed: any external tool can query these, same protocol server browsers
//! use. Reference: <https://developer.valvesoftware.com/wiki/Server_queries>.
