...
#[cfg(any(feature = "s112", feature = "s113", feature = "s122", feature = "s132"))]
compile_error!("the Prns compatibility fork contains only S140 bindings");
...
#[cfg(all(feature = "s140-v6", feature = "s140-v7"))]
compile_error!("S140 v6 and v7 bindings are mutually exclusive");
#[cfg(not(any(feature = "s140-v6", feature = "s140-v7")))]
compile_error!("select exactly one S140 binding version");
#[cfg(feature = "s140-v6")]
pub use nrf_softdevice_s140_v6 as raw;
#[cfg(all(feature = "s140-v7", not(feature = "s140-v6")))]
pub use nrf_softdevice_s140_v7 as raw;
